...
public class ShadowMappingTestWindow extends JOGLFWindow{
	...
	protected void Init() {
		...
		GLShaderFunctions.CreateProgram(
				...
				"./Data/Shader/330/shadow_mapping_2/depth_fshader.glsl");
		GLShaderFunctions.CreateProgram(
				"draw", 
				"./Data/Shader/330/shadow_mapping_2/draw_vshader.glsl",
				"./Data/Shader/330/shadow_mapping_2/draw_fshader.glsl");
	...
	protected void Update() {
		...
		Matrix projection=ProjectionMatrixFunctions.GetPerspectiveMatrix(20.0f, 1.0f, 1.0f, 200.0f);
		...
		CameraFront.SetCameraPositionAndTarget_UpVecY(
				VectorFunctions.VGet(20.0f, 30.0f, 20.0f), VectorFunctions.VGet(0.0f, 0.0f, 0.0f));
