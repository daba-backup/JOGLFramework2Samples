...
public class ButterflyTextureTestWindow2 extends JOGLFWindow{
	private int fbo_id;
	...
	private void SetupProgram() {
		GLShaderFunctions.CreateProgram(
				"butterfly_texture", 
				"./Data/Shader/330/ocean/computation/butterfly_texture/vshader.glsl",
				"./Data/Shader/330/ocean/computation/butterfly_texture/fshader.glsl");
	...
	private void SaveResult() {
		...
		for(int i=0;i<size;i++) {
			data_lines.add(String.valueOf(data.get()));
		}
		
		try {
			FileFunctions.CreateTextFile("./Data/Text/ocean/butterfly_texture.txt", "UTF-8", data_lines);
		}
		catch(IOException e) {
			e.printStackTrace();
		}
